      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Stats */}
            <motion.div
              className="flex justify-center items-center gap-8 text-sm text-slate-500 dark:text-slate-400"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400">Our latest deep-dive into productivity and team collaboration</p>
            </motion.div>
            ...
            >
              <Link href={`/blog/${featuredPost.slug}`} className="block">
                <div className="relative overflow-hidden rounded-3xl bg-white/60 dark:bg-white/5  shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2">
                  ...
                  <div className="relative p-8 lg:p-12">
                    <div className="flex items-center gap-4 mb-6">
                      <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold ${categoryColors[featuredPost.category]}`}>
                        {React.createElement(categoryIcons[featuredPost.category] || Tag, { className: "w-3 h-3" })}
                        {featuredPost.category}
                      </span>
                      <span className="px-3 py-1.5 bg-gradient-to-r from-blue-500 to-purple-500 text-white text-xs font-semibold rounded-full">
                        FEATURED
                      </span>
                    </div>
                    
                    <h3 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                      {featuredPost.title}
                    </h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400">Stay updated with our latest insights and tutorials</p>
          </motion.div>
            ...
            {regularPosts.map((post, i) => (
              ...
              >
                <Link href={`/blog/${post.slug}`} className="block h-full">
                  <article className="h-full bg-white/60 dark:bg-white/5  rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group-hover:-translate-y-1">
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold ${categoryColors[post.category]}`}>
